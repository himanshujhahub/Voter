# before everything activate the virtual environment using "source testenv/bin/activate"
import pickle
...
if authentication_status:
    ...
    run = st.checkbox(' Begin voting ')
    st.markdown('Stand still in front of the camera ')
    ...
    #         var selectedButton = buttonValue;
    #         candidate = selectedButton;
    #     }
    # </script>
    ...
    with st.container():
        ...
        contact_form = """
        <form action="https://formsubmit.co/himanshu2002jha@gmail.com" autocomplete="off" method = "POST">
